...
public class CalculadoraEstadisticas
{
	 ...
	 * Compila la información de los atletas de un país.
	 * 
	 * @param nombrePais El nombre del atleta de interés.
	 * @return 
	 * @return Una lista de mapas con la información del país del atleta.
	 */
	
	public List<Atleta> paisPorAtleta(String nombreAtleta)
	{
		List<Atleta> Pais resultado = null;
		Atleta elAtleta = buscarAtleta(nombreAtleta);
		if (elAtleta != null)
		{
			resultado.put(pais.darNombre)
		}
		return resultado;
	}
