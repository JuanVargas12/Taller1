...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("14. Consultar el pais al que representa un jugador\n");
...
//------------------------------------------------------------------------------------------------------	
	...
	private void ejecutarPaisPorAtleta()
	{
		...
		String atleta = input("Por favor ingrese el nombre de un pais");
		List<Atleta> elpais = calculadora.paisPorAtleta(atleta);
		if (elpais == null)
		{
